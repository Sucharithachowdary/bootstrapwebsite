...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-info "><a href="/static/home.html">HOME</a></div>
            ...
            <img src="/.police.png"   style="height:500px;"  alt="police">
            <table class="table">
                <thead>
                    <tr>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="h2 bg-success" style="height:1000px;">
                ...
                ------------------------------------------------------------------------</br>
                <img src="./map.png"   style="height:300px;"  alt="police">
